...
async function main(tableId) {
  ...
  for (bill of mergedlikeBills) {
    ...
    if (bill.提案人 != undefined) { 
      theFirst = bill.提案人[0]
      nonFirstArr = (partyGroups.includes(theFirst)) ? bill.提案人.slice(2) : bill.提案人.slice(1);
    };
    ...
    const nonFirsts = (nonFirstArr.length > 0) ? nonFirstArr.join("、") : "No Data";
    rowData.push("WIP", bill.first_time, billName, bill.提案編號, nonFirsts, "WIP", ...data)
